...
class SendYourAdToFollowersViewBody extends StatefulWidget {
  const SendYourAdToFollowersViewBody({super.key});

  @override
  State<SendYourAdToFollowersViewBody> createState() =>
      _SendYourAdToFollowersViewBodyState();
}

class _SendYourAdToFollowersViewBodyState
    extends State<SendYourAdToFollowersViewBody> {
  File? _mediaFile;
              ...
              child: Column(
                ...
                children: [
                      ...
                      showDialog(
                        ...
                        builder: (context) {
                          return CustomPickMediaDialog(
                            ...
                            socailMediaImage: Assets.imagesInstagramIcon,
                  ...
                  Center(
                    child: InkWell(
                      onTap: () {
                        context.push("/instagramChooseDestinationSendToFollowrsView");
                      },
                      child: Container(
                        height: 40.h,
                        width: 200.w,
