...
class ChoosePersonAndSendAdViewBody extends StatefulWidget {
  ...
  @override
  State<ChoosePersonAndSendAdViewBody> createState() =>
      _ChoosePersonAndSendAdViewBodyState();
}

class _ChoosePersonAndSendAdViewBodyState
    extends State<ChoosePersonAndSendAdViewBody> {
  File? _mediaFile;
