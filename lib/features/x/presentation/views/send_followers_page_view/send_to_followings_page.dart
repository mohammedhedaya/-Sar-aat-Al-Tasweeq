...
class SendAdXToFollowingsPage extends StatefulWidget {
  const SendAdXToFollowingsPage({super.key});

  @override
  State<SendAdXToFollowingsPage> createState() =>
      _SendAdXToFollowingsPageState();
}

class _SendAdXToFollowingsPageState extends State<SendAdXToFollowingsPage> {
