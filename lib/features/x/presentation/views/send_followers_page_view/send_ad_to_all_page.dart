...
class SendAdXToAllPage extends StatefulWidget {
  const SendAdXToAllPage({super.key});

  @override
  State<SendAdXToAllPage> createState() => _SendAdXToAllPageState();
}

class _SendAdXToAllPageState extends State<SendAdXToAllPage> {
