...
class XUserDetailsSelectAllPage extends StatefulWidget {
  const XUserDetailsSelectAllPage({super.key});

  @override
  State<XUserDetailsSelectAllPage> createState() =>
      _XUserDetailsSelectAllPageState();
}

class _XUserDetailsSelectAllPageState extends State<XUserDetailsSelectAllPage> {
