...
class XUserDetailsSelectFollowingsPage extends StatefulWidget {
  const XUserDetailsSelectFollowingsPage({super.key});

  @override
  State<XUserDetailsSelectFollowingsPage> createState() =>
      _XUserDetailsSelectFollowingsPageState();
}

class _XUserDetailsSelectFollowingsPageState
    extends State<XUserDetailsSelectFollowingsPage> {
