...
import 'package:flutter_svg/flutter_svg.dart'; // Ensure you're using the correct import
...
class WhatsappPageView extends StatefulWidget {
  const WhatsappPageView({super.key});

  @override
  State<WhatsappPageView> createState() => _WhatsappPageViewState();
}

class _WhatsappPageViewState extends State<WhatsappPageView> {
