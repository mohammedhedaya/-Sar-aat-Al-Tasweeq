...
class WhatsappDeleteChatsPage extends StatefulWidget {
  const WhatsappDeleteChatsPage({super.key});

  @override
  State<WhatsappDeleteChatsPage> createState() =>
      _WhatsappDeleteChatsPageState();
}

class _WhatsappDeleteChatsPageState extends State<WhatsappDeleteChatsPage> {
