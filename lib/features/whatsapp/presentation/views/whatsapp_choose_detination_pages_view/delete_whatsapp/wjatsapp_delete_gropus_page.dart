...
class WhatsappDeleteGroupsPage extends StatefulWidget {
  const WhatsappDeleteGroupsPage({super.key});

  @override
  State<WhatsappDeleteGroupsPage> createState() =>
      _WhatsappDeleteGroupsPageState();
}

class _WhatsappDeleteGroupsPageState extends State<WhatsappDeleteGroupsPage> {
