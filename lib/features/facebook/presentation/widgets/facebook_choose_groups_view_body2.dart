...
class FacebookChooseGroupsViewBody2 extends StatefulWidget {
  const FacebookChooseGroupsViewBody2({super.key});

  @override
  State<FacebookChooseGroupsViewBody2> createState() =>
      _FacebookChooseGroupsViewBody2State();
}

class _FacebookChooseGroupsViewBody2State
    extends State<FacebookChooseGroupsViewBody2> {
